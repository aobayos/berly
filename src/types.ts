 ...
 * localStorage library instead (see storage.web.ts). */
 ...
 * Electron IPC on desktop) — see storage.ts and electron/preload.cts. */
export interface StorageBackend {
  ...
  // src/documents.ts checks for openDocument to decide whether the running
