...
import { ELEMENT_TYPES, NEXT_ELEMENT_TYPE, newElement } from '../model/types';
import { builtInTemplates, toTemplate } from '../model/characterSheet';
...
import { toFountain } from '../model/fountain';
import { extractCharacters, extractPlaces } from '../model/suggestions';
...
import { createHistory, pushHistory, undo, redo, type HistoryStack } from '../model/history';
import { reorderScenes } from '../model/sceneBlocks';
import { useIsActiveTab } from '../shell/tabs';
import { useRegisterEditorCommands } from '../shell/commands';
...
export default function Editor() {
  ...
  // registry (src/shell/commands.tsx) — what's left here are the two keys that
