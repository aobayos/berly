...
import type { RecoveryInfo } from '../model/types';
import { useI18n } from '../i18n';
import { discardRecovery, isFileBased, listRecoveries, recover } from '../storage/documents';
import type { TabMeta } from '../shell/tabs';
